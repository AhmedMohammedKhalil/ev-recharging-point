...
?>
	<div class="section" id="login" style="margin-bottom: 33px;">
      <div class="container">
        ...
        <form action="<?php echo $cont."UserController.php?method=editProfile"?>" method="POST" class="form" enctype="multipart/form-data">
          <?php
            if(isset($_SESSION['errors'])) {
          ...
          <div style="display: flex;justify-content:center;flex-direction:column">
            <div>
                ...
                value="<?php if(isset($_SESSION['errors'])){ echo $email; } else { echo $_SESSION['User']['email'];}?>">
            </div>
            <div>
                <label for="name">Name</label>
                <input type="text" name="name" id="name" title="Enter name" placeholder="Enter name" required
                value="<?php if(isset($_SESSION['errors'])) { echo $name ;} else { echo $_SESSION['User']['name'];}?>">
            </div>

            <div>
                <label for="mobile">Mobile</label>
                <input type="text" name="mobile" id="mobile" title="Enter Mobile" placeholder="Enter Mobile" required
                value="<?php if(isset($_SESSION['errors'])) { echo $mobile ;} else { echo $_SESSION['User']['mobile'];}?>" pattern="[0-9]{8}" maxlength="8">
            </div>
            ...
            <div>
                ...
                value="<?php if(isset($_SESSION['errors'])) { echo $office_phone ;} else { echo $_SESSION['User']['office_phone'];}?>" pattern="[0-9]{8}" maxlength="8">
            </div>
